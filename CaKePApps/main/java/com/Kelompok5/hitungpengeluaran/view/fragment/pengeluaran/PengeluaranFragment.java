package com.Kelompok5.hitungpengeluaran.view.fragment.pengeluaran;
...
import com.Kelompok5.hitungpengeluaran.utils.FunctionHelper;
import com.Kelompok5.hitungpengeluaran.view.fragment.pengeluaran.add.AddPengeluaranActivity;
    ...
    public void onDelete(ModelDatabase modelDatabase) {
        ...
        alertDialogBuilder.setPositiveButton("Ya, Hapus", (dialogInterface, i) -> {
            ...
            if (sKeterangan.equals("OK")) {
                Toast.makeText(requireContext(), "Data sudah dihapus", Toast.LENGTH_SHORT).show();
            }
        });
